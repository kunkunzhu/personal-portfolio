...
class BeingBelongingJournal extends Component {
    render() {
        return (
            <Wrapper>
                <Header>
                    <img src="https://i.ibb.co/3C1D0X9/portrait.jpg" alt="cover"/>
                    <div className="info">
                        <h1>
                            to be & to belong.
                        </h1>
                ...
                <Body>
                    ...
                    and their suffering and their joy, our deep and ongoing need for connection".</i> I thought — 
                    <i>I feel the same way</i>. I am constantly reminded of the amorphous depth that exists within another 
                    human, how a thousand strangers around me resemble a thousand kaleidoscopic constellations 
                    of unparalleled perspectives and untold narratives. I dwell among the fragments of our shared 
                    experience — recorded in the form of novels and films and essays that overflow with honesty — 
                    which, at the end of the day, leave me wide-eyed before the curious and inevitable experience 
                    that it is to be human. What fickle and detestable and resolute and heartening creatures that 
                    we are. If all else is rendered to be an illusion then this is what remains real.
                    </div>
                    <div className="paragraph">
                    ...
                    <div className="paragraph">
                    At one point in time I came to conclude that somehow, my ability to form social connection 
                    with others must be defective. It all seems somewhat melodramatic from a distance away, 
                    but at the time, the gravity of it all felt tangibly real. In order to be worthy of connection, 
                    I felt as though I needed to be extroverted and at ease. I was not. I felt and noticed too 
                    much to carry an air of nonchalence. I was the awkward teen, treading upon invisible eggshells 
                    and carrying my over-sensitivities with a lack of grace. 
                    </div>
                    <div className="paragraph">
                    ...
                    <div className="paragraph">
                    So all along, I have been the author of my own rejection. A barren field sprawled across 
                    the landscape within and I thought that the acceptance and affection of others were 
                    the only flowers that could possibly take residence. If I were to unclench, I would 
                    discover that the seeds were all held within my still-clammy palms. Instead, I built 
                    walls to conceal that ever existed a field at all.
                    </div>
                    <img src="https://i.ibb.co/BtKCxSG/01.png" alt="rejection 01"/>
                    <div className="paragraph">
                    During a heated conversation with my boyfriend, I found myself tempted to withdraw. 
                    The chasm of difference between us was what drew me into the relationship in the very 
                    beginning, wide-eyed with curiosity at the potentiality that intimacy could contain. 
                    But in the moment, that chasm felt like an alienating barrier. <i>We are so different.</i> 
                    I think while biting my lips. But I do not love another merely for the reflection 
                    of myself that I see in the other. But this nebulous in-between of our differences 
                    is what stretches and grows me — making it all worthwhile.
                    </div>
                    <div className="paragraph">
                    ...
                    within? It will not be an overnight process, but it will be worthwhile. I am learning 
                    to give myself the permission to draw near to belonging, showing up raw and fragmented 
                    and nevertheless worthy.
                    </div>
                    <img src="https://i.ibb.co/6v4Yb7W/02.png" alt="rejection 02"/>
                    <div className="paragraph">
                    ...
                    <div className="paragraph">
                    Perhaps it was something of a coming-of-age miracle, the insecurities that I carried 
                    were but characteristic of adolescence. Perhaps it has to do with the social isolation 
                    of the past year's pandemic, bringing the core need of connection and belonging into 
                    open exposure. Suddenly everyone was voicing the same longing that I have always felt 
                    pulsing beneath the surface of my skin. In this communal loneliness, I suddently felt 
                    less alone. 
                    </div>
                    <div className="paragraph">
                    Perhaps it was the very gift within solitude that I have been invited into — both the 
                    place I desired to outrun from and where I unearthed my strength — learning to be at 
                    home within myself so I could be at ease among others. This process of distentangling 
                    and reconciling is somewhere I continue to abide.
                    </div>
                    ...
                    rhythmed to a similar ache. We are merely fickle and detestable and resolute and heartening 
                    creatures navigating through this curious and inevitable shared experience of life. 
                    ...
                    sometimes the brevity of it all pains me. 
                    </div>
                    <div className="paragraph">
                    ...
                    and candid conversations. I desire for nothing less but to dive beneath the surface 
                    and towards the nebulous ocean of our collective experience. I want to hold intent eye 
                    contact and ask sincere questions. I want to stand alongside you and feel empathy 
                    pulsing through us. I want to hold space for your story and be left in awe by how 
                    wildly different and terrifyingly similar that we are — you may never walk an inch 
                    in my shoes but you know my tears and joys and my longing to belong, as intimately 
                    as I know yours.
                    </div>
                    <div className="paragraph">
...
export default BeingBelongingJournal